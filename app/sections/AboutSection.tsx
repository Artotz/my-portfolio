  ...
  return (
    <div className="flex flex-col flex-grow justify-center items-center gap-4">
      <div className="flex flex-col flex-grow w-1/2 font-semibold text-2xl text-center justify-center items-center gap-4">
        {[
          <p>{`Meu nome é Artur Melo Catunda.`}</p>,
          <p>{`Sou Desenvolvedor Web especializado em React.js, React Native e Tailwind CSS, mas com sólida experiência também em back-end utilizando Express e Spring. Também tenho familiaridade com o uso de Docker, GitHub Actions e AWS para criação de ambientes de desenvolvimento e hospedagem.`}</p>,
          <p>{`Trabalho com metodologias ágeis e boas práticas de desenvolvimento. Minhas principais habilidades incluem foco, resiliência, comprometimento, organização e solução de problemas, características que sempre aplico em meus projetos para entregar soluções eficientes e bem estruturadas.`}</p>,
          <p>{`No meu tempo livre, adoro desenvolver jogos, assistir filmes de terror e jogar jogos de tabuleiro e cartas. Se precisar de um currículo ou quiser bater um papo, fico à disposição!`}</p>,
        ].map((v, i) => {
          return (
            <motion.div
              className="flex"
