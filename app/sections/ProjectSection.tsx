...
function PortfolioSectionIconButton(props: PortfolioSectionIconButtonProps) {
  return (
    <a
      ...
      target="_blank"
      className={
        "flex flex-row justify-start items-center p-2 gap-0 hover:gap-2 duration-500 hover:scale-125 fill-black hover:fill-white bg-white hover:bg-black rounded-xl font-semibold text-[0] hover:text-sm hover:text-white text-black"
      }
    >
      {props.icon == "source" ? (
        <>
