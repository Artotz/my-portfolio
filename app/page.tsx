    ...
    <main className="min-h-screen bg-zinc-950 text-white spectrum-surface">
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 text-left">
          <h2 className="text-3xl font-bold text-white sm:text-4xl spectrum-text">
            {t.Cta.title}
          </h2>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              className="rounded-full bg-indigo-500 px-5 py-2 text-sm font-semibold text-white transition hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400 spectrum-button"
            >
              {t.Cta.emailLabel}
            </a>
            <a
